...
We will now discuss how the variables, `gender`, `race`, and `gunown`, were measured and how they became an entry in our dataset. Each variable was associated with a related question, and the self-reported response of each individual from the online questionnaire was recorded in the dataset. Some notes on measurement error and missing data are required for each variable.
